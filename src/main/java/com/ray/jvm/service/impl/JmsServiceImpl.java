package com.ray.jvm.service.impl;

import com.ray.jvm.common.enums.ErrorCode;
import com.ray.jvm.common.exception.RuntimeException;
import com.ray.jvm.common.util.DateUtil;
import com.ray.jvm.core.enums.PoolEnum;
import com.ray.jvm.core.model.JmsServicePrevModel;
import com.ray.jvm.core.model.ServiceDescriptor;
import com.ray.jvm.core.util.JmxMetricsService;
...
public class JmsServiceImpl implements IJmsService {
    ...
    public Response4overviewVO getOverview(ServiceDescriptor descriptor) {
        if (descriptor == null) {
            throw new RuntimeException(ErrorCode.SERVER_ERROR.getCode(), "没有获取到ServiceDescriptor");
        }
